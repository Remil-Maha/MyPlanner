...
import com.example.authentificationutilisateur.swing.*;
...
public class CalendarCustom extends javax.swing.JPanel {
    ...
    public CalendarCustom() {
        initComponents();
        thisMonth();
        slide.show(new PanelDate(LocalDate.now().getMonthValue(), LocalDate.now().getYear()), PanelSlide.AnimateType.TO_RIGHT);
        showMonthYear();
    ...
    private void initComponents() {
        ...
        slide = new com.example.authentificationutilisateur.swing.PanelSlide();
        ...
        jPanel1.setBackground(new java.awt.Color(40,141,138));

        jPanel2.setBackground(new java.awt.Color(40,141,138));
      ...
      //  cmdBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("com/example/mydesktopplanner/icon/next.png"))); // NOI18N
        cmdBack.setText("<");
        ...
        lbMonthYear.setForeground(new java.awt.Color(40,141,138));
        lbMonthYear.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbMonthYear.setText("Month - Year");

       // cmdNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("com/example/mydesktopplanner/icon/back.png"))); // NOI18N
       cmdNext.setText(">");
    ...
    private com.example.authentificationutilisateur.swing.PanelSlide slide;
